	...
	public void gameStart(int nowSelected, String difficulty) { // 인덱스번호, 난이도
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                loginDAO.scoreUpdate(game.score, trackList.get(nowSelected).getTitleName());
