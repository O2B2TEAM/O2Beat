...
//변수
    ...
    private HashMap<String, Integer> scores; // 새로 추가
...
//        scoreLabel = new JLabel("현재 점수: " + scores.get(username));
//        scoreLabel.setBounds(300, 300, 30, 30);
//        scoreLabel.setFont(new Font("Serif", Font.BOLD, 30));
//        scoreLabel.setForeground(Color.WHITE); //텍스트 색상 설정
//        
//        add(scoreLabel);
        ...
        setVisible(true); //실행 시 화면 보이기 == true
